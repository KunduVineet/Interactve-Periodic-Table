...
const Lanthanoids = () => {
    ...
    const handleClick = (lanthanides) => {
        setselectedLanthanide(lanthanides);
    };
            ...
            {selectedLanthanide && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md sm:max-w-sm overflow-y-auto text-black">
                        <h3 className="text-2xl font-bold mb-4 text-center">{selectedLanthanide.name}</h3>
                        <div className="grid grid-cols-1 gap-2">
                            <p><strong>Atomic Number:</strong> {selectedLanthanide.atomicNumber}</p>
                            <p><strong>Symbol:</strong> {selectedLanthanide.symbol}</p>
                            <p><strong>Type:</strong> {selectedLanthanide.type}</p>
                            <p><strong>Electronegativity:</strong> {selectedLanthanide.electronegativity}</p>
                            <p><strong>Oxidation State:</strong> {selectedLanthanide.oxidationState}</p>
